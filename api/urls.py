...
from api.StreetCardServices.views import SocialWorkerRegistration, SocialWorkerDetails,HomelessView,UserViewSet,UserMapping
...
router.register('homeless', HomelessView)
