...
class TestHomelessSerializer(TestCase):
    ...
    def test_serializer_fields(self):
        for field_name in self.serializer.data.keys():
            ...
            self.assertEqual(self.serializer.data[field_name], str(getattr(self.client, field_name))) if(field_name == 'DOB') \
...
class TestTransactionSerializer(TestCase):
    ...
    def test_serializer_fields(self):
        for field_name in self.serializer.data.keys():
            self.assertEqual(self.serializer.data[field_name], self.client.PersonalId)  if(field_name =='personalId')\
            else self.assertEqual(self.serializer.data[field_name], getattr(self.transaction, field_name))
...
class TestHousingAssessmentAtExitSerializer(TestCase):
    ...
    def test_serializer_fields(self):
       for field_name in self.serializer.data.keys():
            self.assertEqual(self.serializer.data[field_name], self.enroll.EnrollmentID)if(field_name == 'EnrollmentID')\
    ...
    def test_serializer_fields(self):
       for field_name in self.serializer.data.keys():
            if(field_name == 'EnrollmentID'):
                ...
                self.assertEqual(self.serializer.data[field_name], str(getattr(self.fassvf,field_name)))
            else:
...
class TestPercentAMISerializer(TestCase):
   ...
   def test_serializer_fields(self):
       self.assertEqual(self.serializer.data['EnrollmentID'], self.enroll.EnrollmentID)
       self.assertEqual(self.serializer.data['HouseholdIncomeAsAPercentageOfAMI'], self.ami.HouseholdIncomeAsAPercentageOfAMI)
