    ...
    handleOnSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                servicesProvidedSSVFObject.DateOfService = values['dateofservice'].format['YYYY-MM-DD'];
                ...
                employmentStatusObject.InformationDate = values['informationdate'].format['YYYY-MM-DD'];
